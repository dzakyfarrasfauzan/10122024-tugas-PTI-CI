...
class Newitem extends CI_Controller
{
	...
	// Menampilkan halaman utama daftar item
	...
	// Menampilkan semua item tanpa pagination
	...
	// Proses untuk menambah atau memperbarui item
	...
	// Menampilkan item berdasarkan kode model
