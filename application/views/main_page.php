				...
				<section class="col-lg-12 connectedSortable">
					...
					<div class="nav-tabs-custom">
						...
						<div class="tab-content no-padding">
							...
							<div class="chart tab-pane" id="alamat-pabrik" style="position: relative; height: 250px;">
								<br/>
								<div class="col-md-1"></div>
								<div class="col-md-10">
...
<script>
  $(document).ready(function() {
    ...
    var chart = new Chart(ctx, {
      ...
      type: 'bar',
      responsive: true,
      maintainAspectRatio: false, // Corrected typo: 'mainAspectRation' -> 'maintainAspectRatio'
